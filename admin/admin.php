    ...
    <div class="bg-light">
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary  d-flex align-items-center">
               ...
               <button class="p-1"><a href="admin.php?insertbrand" class="nav-link text-light bg-danger my-3 pd-3">Insert Brands</a></button>
               <button class="p-1"><a href="" class="nav-link text-light bg-danger my-3 pd-3">View Brands</a></button>
               <button class="p-1"><a href="" class="nav-link text-light bg-danger my-3 pd-3">All Orders</a></button>
               <button class="p-1"><a href="" class="nav-link text-light bg-danger my-3 pd-3">All Payments</a></button>
               <button class="p-1"><a href="" class="nav-link text-light bg-danger my-3 pd-3">List Users</a></button>
               <button class="p-1"><a href="" class="nav-link text-light bg-danger my-3 pd-3">Log Out</a></button>
                </div>
            </div>
        </div>
