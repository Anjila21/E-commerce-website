...
if(isset($_POST['insert_product']))
{
    ...
    $product_image1=$_FILES['product_product_image1']['name'];
    $product_image2=$_FILES['product_product_image2']['name'];
    $product_image3=$_FILES['product_product_image3']['name'];

    $temp_image1=$_FILES['product_product_image1']['tmp_name'];
    $temp_image2=$_FILES['product_product_image2']['tmp_name'];
    $temp_image3=$_FILES['product_product_image3']['tmp_name'];
...
<div class="form-outline mb-4 w-50 m-auto">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
         ...
         <input type="text" name="product_description" id="product_price" class="form-control" placeholder="Enter Product Price" autocomplete="off" required>
        </div>
        <div class="form-outline mb-4 w-50 m-auto">
